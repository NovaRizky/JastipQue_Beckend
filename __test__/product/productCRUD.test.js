...
describe('TEST ENDPOINT /products Feature', () => {
  // -- Start of GET -- 
  test('GET /products should return 200 and all products', (done) => {
    request(app)
      .get(`${endpoint}`)
      .expect(200)
  ...
  test('GET /products/:id should return 200 and the chosen product itself', (done) => {
    request(app)
      .get(`${endpoint}/1`)
      .expect(200)
      .set('access_token', accessTokenAdmin)
  ...
  test('GET /products without access_token should return 401', (done) => {
    request(app)
      .get(`${endpoint}`)
      .expect(401)
      .then(({ body }) => {
  ...
  // -- Start of POST --
  test('POST /products should return 201', (done) => {
    const testData = {
      name: 'M1 Laptop',
      description: 'The fastest laptop with newest processor',
      image: 'test-image-http',
      status: 'Active',
      price: 100000,
      stock: 10,
      weight: 30,
  ...
  // -- Start of DELETE -- 
  test('DELETE /products/:id should return 200', (done) => {
    request(app)
      .delete(`${endpoint}/1`)
      .expect(200)
      .set('access_token', accessTokenAdmin)
      .then(({ body }) => {
        expect(body).toMatchObject({
          message: "PC Gaming Core I5 9400/RX 570 4 GB/DDR4 16 GB/Samsung 24 Curved success to delete"
        })
        done();
      })
      .catch((error) => {
  ...
  test('DELETE /products/:id with invalid id should return 404', (done) => {
    request(app)
      .delete(`${endpoint}/99`)
      .expect(404)
      .set('access_token', accessTokenAdmin)
  ...
  // -- Start of PATCH --
  test('PATCH /products/:id should return 200', (done) => {
    const testData = {
      status: "Inactive"
    }
    ...
    request(app)
      ...
      .then(({ body }) => {
        expect(body).toMatchObject({
          message: "status ROG Zephyrus Duo 15 SE was updated"
        })
        done();
      })
      .catch((error) => {
  ...
  test('PATCH /products/:id with invalid id should return 404', (done) => {
    const testData = {
      status: "Inactive"
    }
