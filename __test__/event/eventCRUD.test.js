...
describe('TEST ENDPOINT /events Feature', () => {
  // -- Start of GET -- 
  test('GET /events should return 200 and all events', (done) => {
    request(app)
      .get(`${endpoint}`)
      .expect(200)
      ...
      .then(({ body }) => {
        ...
        expect(body[0].Products.length).toBe(3)
        done();
      })
      .catch((error) => {
        done(error);
  ...
  // -- Start of POST --
  test('POST /events should return 201', (done) => {
    const testData = {
      name: 'INDOCOMTECH',
      address: "Jakarta Convention Center, DKI Jakarta",
      start: "15 January 2023",
      finish: "21 January 2023"
    };
    ...
    request(app)
      ...
      .then(({ body }) => {
        expect(body).toMatchObject({
          ...
          name: 'INDOCOMTECH',
          address: "Jakarta Convention Center, DKI Jakarta",
          start: "2023-01-14T17:00:00.000Z",
          finish: "2023-01-20T17:00:00.000Z",
  ...
  test('POST /events without one of the required paramaters (address) should return 400', (done) => {
    const testData = {
      name: 'INDOCOMTECH',
      start: new Date(),
      finish: new Date()
  ...
  test('POST /events with empty string on one of the required paramaters (address) should return 400', (done) => {
    const testData = {
      name: 'INDOCOMTECH',
      address: '',
      start: new Date(),
  ...
  test('POST /events without access_token should return 401', (done) => {
    const testData = {
      name: 'INDOCOMTECH',
      address: '',
      start: new Date(),
  ...
  // -- Start of PUT --
  test('PUT /events should return 200', (done) => {
    const testData = {
      name: "IndoComTech",
      start: "15 January 2023",
      finish: "21 January 2023",
      address: "Bekasi",
      mapsUrl: "http-google-map",
    };
  ...
  test('PUT /events without access_token should return 401', (done) => {
    const testData = {
      name: "IndoComTech",
      start: "15 January 2023",
      finish: "21 January 2023",
